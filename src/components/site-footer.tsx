...
/* Brand glyphs from Simple Icons (CC0), inlined to avoid a dependency. */
const socials = [
  {
    label: "Discord",
    href: links.discord,
...
const columns = [
  {
    title: "Unit",
    links: [
      { label: "Milsim Guide", href: "/milsim-guide" },
      { label: "Roles", href: "/roles" },
      { label: "Operations", href: "/operations" },
      { label: "Ranks & Awards", href: "/progression" },
    ],
  },
  {
    title: "Join",
    links: [
      ...
      { label: "Recruit Guide", href: "/recruit" },
      { label: "Enlist", href: billet.applyUrl },
    ],
  },
  {
    title: "Community",
...
export function SiteFooter() {
  return (
    <footer className="border-t border-edge bg-surface">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 md:flex md:justify-between md:gap-12">
        ...
        <nav
          aria-label="Footer"
          className="mt-8 grid grid-cols-2 gap-8 sm:grid-cols-3 md:mt-0"
        >
          {columns.map((column) => (
